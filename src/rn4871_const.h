 ...
 * rn4871_const.h
 *
 * Created: 09-07-2025 11:40:57
 *  Author: Subrata
 */ 


#ifndef RN4871_CONST_H_
#define RN4871_CONST_H_


// ------------------- Serial -------------------------
#define DELAY_BEFORE_CMD      100   // delay before the first '$' to enter into command mode
#define DEFAULT_CMD_TIMEOUT   400   // default timeout
...
#define LIST_SERVICES_AND_CHARS	"LS"
